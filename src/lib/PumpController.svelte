...
{#if connected}
    ...
    >
        <div class="flex flex-row items-start w-full shrink-0 justify-between">
            ...
            <div class="flex flex-col rounded-lg max-w-60 gap-5">
                ...
                <div class="flex flex-col bg-gray-100 rounded-lg w-full p-6">
                    ...
                    <p class="text-gray-500">
                        Connected: <span class="text-green-500"
                            >{connected}</span
                        >
                    </p>
                    ...
                    <p class="text-gray-500">
                        Mode: <span
                            class={config.mode === "inflow"
                                ? "text-purple-500"
                                : "text-blue-500"}>{config.mode}</span
                        >
                    </p>
